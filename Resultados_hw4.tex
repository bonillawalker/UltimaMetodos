...
\begin{figure}
    \centering
    \includegraphics{projectile45.png}
    \caption{45 grados}
    \label{fig:my_label}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics{projectiles7angulos.png}
